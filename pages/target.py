...
column2 = dbc.Col(
    [
        dcc.Markdown(
            ...
            To accomplish this, I used the 2017 Hospital Inpatient Discharge dataset for the State of New York. Included was a column called “Risk of Mortality” which I set as my target while I trained my model. Risk of Mortality had the target classes of minor, moderate, major and extreme which I label encoded to the ordinal rank of 1, 2, 3 and 4 respectively. As we see below, the distribution of risk of mortality across the patients is skewed right with the majority of inpatients having a minor risk of mortality (1).
